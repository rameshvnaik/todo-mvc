...
export const Item = memo(function Item({ todo, dispatch, index }) {
    ...
    const { title, completed, id,neewelyAdded } = todo;
            ...
            <div className="view">
                {isWritable ? (
                    ...
                    <>
                        ...
                        <label data-testid="todo-item-label" onDoubleClick={handleDoubleClick} className={neewelyAdded? "newely-added": undefined}>
                            {title}
                        </label>
